...
# Calculate the p-value. It is the probability (area under the curve) of obtaining a specific value
# in this null distribution
...
# in this way, we calculate how (im)probable it is to obtain the test parameters...
# ... when the null hypothesis is true

# If the slope value estimated by the regression is close to 0, it will have a high probability...
# ... of occurring in the null distribution
...
# In the confidence interval, the question is:
# What is the probability of a parameter = zero being contained in the distribution of estimates?
